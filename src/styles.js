...
export const ICONS = {
  ...
  blockNotif: require(ASSETS_PATH + "block-notif.png"),
  allowNotif: require(ASSETS_PATH + "allow-notif.png"),
  microphone: require(ASSETS_PATH + "microphone.png"),
  stopRecord: require(ASSETS_PATH + "stop.png"),
  ...
  internetOnlineGIF: require(GIFS_PATH + "internetOnlineGIF.gif"),
  internetOfflineGIF: require(GIFS_PATH + "internedDisconnectedGIF.gif"),
  ...
  caretLeft: require(ASSETS_PATH + "caret-left.png"),
  caretRight: require(ASSETS_PATH + "caret-right.png"),
  trash: require(ASSETS_PATH + "trash.png"),
  archive: require(ASSETS_PATH + "archive.png"),
  ...
  popperCelebration: require(GIFS_PATH + "popperCelebration.gif"),
  guyCelebrating: require(GIFS_PATH + "guyCelebrating.gif"),
