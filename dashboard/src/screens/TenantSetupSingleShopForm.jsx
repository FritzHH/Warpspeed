...
// Single-shop wizard. Merges the prospect-relevant fields from the dashboard
// New Tenant + Add Store pages, deduped: the business name is also the store
// name, and the business address is also the store address. Provisioning
// (later step) splits the same form data across tenant + a single store
// document.
//
    ...
    <div className="centerScreen">
      <div className="card cardWide">
        ...
        <p className="cardSubtitle">
          Signed in as <strong>{email}</strong>. One short form covers both
          your business and your single store. Your progress saves
          automatically as you fill in each field.
        </p>

        <div className="sectionHeading">Shop</div>

        <div className="fieldLabel">Business / shop name</div>
        <input
          className="textInput"
          type="text"
