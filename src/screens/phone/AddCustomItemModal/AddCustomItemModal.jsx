...
export function AddCustomItemModal({ existingLine = null, onSave, onClose }) {
  ...
  function handleSave() {
    ...
    invItem.category = "Item";
    invItem.customLabor = false;
    invItem.customPart = true;
    invItem.minutes = 0;
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.header}>
        ...
        <span className={styles.title}>{isEditing ? "Edit" : "Add"} Custom Item</span>
      </div>
