...
import { dbGetCustomer, dbUploadWorkorderMedia } from "../../db_calls_wrapper";
...
export function MobileWorkorderDetailScreen() {
  ...
  // Load customer data when workorder changes — mirrors Options_Workorders.js pattern
  useEffect(() => {
  ...
  // Same logic as Info_ActiveWorkorder.js:78-94
    ...
    >
      ...
      {zWorkorder.workorderLines?.length > 0 && (
        ...
        >
          ...
          >
            Items ({zWorkorder.workorderLines.length})
          </Text>
